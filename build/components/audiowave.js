...
const AudioWave = ({ duration, paused }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { style: { paddingLeft: '0%', marginBottom: '0rem' } },
            React.createElement("span", { style: { color: 'red', cursor: 'pointer', padding: '0 1.5rem' }, onClick: () => ajustTime(currentTime + 0.1) }, "\uFF0B0.1s \u2191"),
            ...
            React.createElement("br", null),
            React.createElement("span", { style: { color: 'blue', cursor: 'pointer', padding: '0 1.5rem' }, onClick: () => ajustTime(currentTime - 0.1) }, "\u30FC0.1s \u2193")),
